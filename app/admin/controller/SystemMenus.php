...
use app\system\services\SystemRouteCateServices;
...
class SystemMenus extends AuthController
{
    ...
    {
        return app('json')->success($service->getAllList('admin'));
    }
    ...
    {
        $cateId = request()->get('store_category_id', 0);
        //获取所有的路由
        $ruleList = $services->selectList(['store_category_id' => $cateId, 'app_name' => 'admin'])->toArray();
