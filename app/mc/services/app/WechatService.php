...
use app\mc\services\easywechat\pay\Order;
use app\mc\services\easywechat\Application;
use app\mc\services\easywechat\pay\Application as PayApplication;
...
class WechatService
{
     ...
     */
    public static function payApplication($cache = false)
    {
        (self::$payInstance === null || $cache === true) && (self::$payInstance = new PayApplication(self::options()));
        return self::$payInstance;
    }
    ...
    {
        return self::payApplication()->payment;
    }
