...
// +----------------------------------------------------------------------
namespace app\mc\services\upload\storage;

use app\mc\services\upload\BaseUpload;
use app\mc\exceptions\AdminException;
use app\mc\exceptions\UploadException;
use GuzzleHttp\Psr7\Utils;
use Qcloud\Cos\Client;
use QCloud\COSSTS\Sts;
use app\mc\services\upload\extend\cos\Client as McClient;

/**
 * 腾讯云COS文件上传
 * Class COS
 * @package app\mc\services\upload\storage
 */
