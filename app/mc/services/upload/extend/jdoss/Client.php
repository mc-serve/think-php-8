...
namespace app\mc\services\upload\extend\jdoss;


use app\mc\exceptions\UploadException;
use app\mc\services\upload\BaseClient;
 ...
 * @date 2023/5/18
 * @package app\mc\services\upload\extend\jdoss
 */
class Client extends BaseClient
{
     ...
     * @param string $bucket
     * @param string $region
     * @return array|bool|\app\mc\services\upload\extend\cos\SimpleXMLElement
     * @author 等风来
     * @email 136327134@qq.com
     * @date 2022/10/17
     */
    ...
    /**
     * 获取桶列表
     * @return array|\app\mc\services\upload\extend\cos\SimpleXMLElement
     * @author 等风来
     * @email 136327134@qq.com
     * @date 2023/5/18
     */
