...
use app\mc\utils\fileVerification;
use app\mc\exceptions\AdminException;
use app\system\dao\upgrade\UpgradeLogDao;
...
{
    const LOGIN_URL = 'http://upgrade.mc-serve.com/api/login';
    const UPGRADE_URL = 'http://upgrade.mc-serve.com/api/upgrade/list';
    const UPGRADE_CURRENT_URL = 'http://upgrade.mc-serve.com/api/upgrade/current_list';
    const AGREEMENT_URL = 'http://upgrade.mc-serve.com/api/upgrade/agreement';
    const PACKAGE_DOWNLOAD_URL = 'http://upgrade.mc-serve.com/api/upgrade/download';
    const UPGRADE_STATUS_URL = 'http://upgrade.mc-serve.com/api/upgrade/status';
    const UPGRADE_LOG_URL = 'http://upgrade.mc-serve.com/api/upgrade/log';
...
//        }
    ...
    public function getUpgradeLogList(): array
    {
        ...
        foreach ($list as &$item) {
            ...
            $item['upgrade_time'] = $item['upgrade_time'];
        }
