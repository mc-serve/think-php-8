...
use app\system\dao\SystemCrudDao;
use app\mc\basic\BaseServices;
use app\mc\exceptions\AdminException;
use app\mc\services\crud\Controller;
use app\mc\services\crud\Dao;
use app\mc\services\crud\enum\FormTypeEnum;
use app\mc\services\crud\enum\SearchEnum;
use app\mc\services\crud\Make;
use app\mc\services\crud\Model;
use app\mc\services\crud\Route;
use app\mc\services\crud\Service;
use app\mc\services\crud\Validate;
use app\mc\services\crud\ViewApi;
use app\mc\services\crud\ViewPages;
use app\mc\services\crud\ViewRouter;
...
class SystemCrudServices extends BaseServices
{
    ...
    const NOT_CRUD_TABANAME = [
        ...
        'system_admin', 'eb_system_city', 'system_log', 'system_menu', 'system_notice',
        ...
        'user_brokerage', 'store_product_cate', 'store_bargain_user_help', 'shipping_template_region',
        'shipping_template_no_delivery', 'shipping_template_free', 'other_order_status', 'lang_code',
        ...
        'capital_flow', 'category', 'diy', 'express', 'lang_type', 'live_anchor', 'live_good', 'live_room',
        'live_room_goods', 'luck_lottery', 'luck_lottery_record', 'luck_prize', 'member_card',
        'member_card_batch', 'member_right', 'member_ship', 'system_message', 'other_order',
        'other_order_status', 'out_account', 'out_interface', 'page_category', 'page_link', 'qrcode',
        'shipping_template', 'shipping_template_free', 'shipping_template_no_delivery',
        'shipping_template_region', 'sms_record', 'store_advance', 'store_bargain', 'store_bargain_user',
...
//            }
    ...
    public function createCrud(int $id, array $data)
    {
        ...
        $res = $this->transaction(function () use ($tableComment, $tableCreateInfo, $crudInfo, $modelName, $filePath, $tableName, $routeName, $data, $dataMenu) {
            ...
            //写入路由权限
            $cateId = app()->make(SystemRouteServices::class)->topCateId('admin', 'CRUD');
            $ruleData = [
                [
                    'path' => $routeName,
                    'method' => 'GET',
